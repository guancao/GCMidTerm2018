...
public class Anagram {
    ...
    public static void main(String[] args) {
        ...
        String str1 = "ACD";
        String str2 = "TCA";
        if (anagramCheck(str1, str2)) System.out.println("This is two strings are anagram!");
        else System.out.println("This is two strings are NOT anagram!!!");
    }
    ...
    public static boolean anagramCheck(String str1, String str2) {
        ...
        if (str1.length() == str2.length()) try {
            ...
            for (int k = 0; k < charList1.size(); k++) {
                if (charList1.get(k) != charList2.get(k)) isAnagram = false;
            }
            return isAnagram;
        } catch (Exception e) {
            e.printStackTrace();
